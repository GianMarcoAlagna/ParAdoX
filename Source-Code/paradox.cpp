...
main()
{
  ...
  std::cout << "\n\nI'm actually finding this a lot more fun than I thought I would,\n I may actually try to keep developing this into a larger story,\n  as just kinda a fun side project idk, I'm liking it.\n   Maybe I'll make a real GUI for it sometime idk.\n";
