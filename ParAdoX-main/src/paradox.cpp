...
main()
{
  ...
  std::cout << "You come up to a door looks worn down, probably hasn't been used in a whill.\n";
  std::cout << "You see it goes down even further.\n";
  std::cout << "Partner: Theres gotta be another way it's dark as hell down there.\n\n";
  std::cout << "1) 'Well I don't see another way, do you?\n'";
  std::cout << "2) 'I'm going down either way do what you want.'";
  
  if (choise == 1) {
    std::cout << "You: Well I don't see another way do you?\n";
    std::cout << "Partner: I guess not but you're going first\n";
    std::cout << "*You nod your head in acknowledgment*\n";
  } else {
    std::cout << "You: I'm going down either way do what you want.";
    std::cout << "Partner: Alright whatever but no need to be an ass about it.";
  }
